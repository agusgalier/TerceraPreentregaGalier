...
def crear_futbolista(request):
    if request.method == 'POST':
        ...
        if formulario.is_valid():
            ...
            futbolista.save()
            messages.success(request, f'El jugador {futbolista.nombre} se ha creado exitosamente.')
...
def crear_basquetbolista(request):
    if request.method =='POST':
        ...
        if formulario.is_valid():
            ...
            basquetbolista.save()
            messages.success(request, f'El jugador {basquetbolista.nombre} se ha creado exitosamente.')
...
def crear_tenista(request):
    ...
    if request.method =='POST':
        ...
        if formulario.is_valid():
            ...
            tenista.save()
            messages.success(request, f'El jugador {tenista.nombre} se ha creado exitosamente.')
